...
Request login authentication using exampleCreateUserSession type which is delivered as
...
```json
{
    ...
    "password":	"ir9bvrwkji1avis5q73i",

    "expiration":	null,

    "email":	"wShaw@Fivespan.gov"
...
Info returns total of records available in api for type example.UserClaim.
